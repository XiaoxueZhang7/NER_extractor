...
if __name__ == "__main__":
    ...
    AsenDict = NER_PO('资讯', 'https://www.jiqizhixin.com/articles/2018-10-25-8', useExpanded=[1,0,1])
    print '===== '+' jieba '+' 关系测试'+'exactScorer=False'+' useExpanded=[1,0,1] '+' accurateMode=False '+' ====='
    relationScorer(OrelationDict, OnameDict, OactionList, OotherList, AsenDict, exact=False)

    AsenDict = NER_PO('资讯', 'https://www.jiqizhixin.com/articles/2018-10-25-8', useExpanded=[0,0,0])
    print '===== '+' jieba '+' 关系测试'+'exactScorer=True'+' useExpanded=[0,0,0] '+' accurateMode=False '+' ====='
    relationScorer(OrelationDict, OnameDict, OactionList, OotherList, AsenDict)

    AsenDict = NER_PO('资讯', 'https://www.jiqizhixin.com/articles/2018-10-25-8', useExpanded=[0,0,0])
    print '===== '+' jieba '+' 关系测试'+'exactScorer=False'+' useExpanded=[0,0,0] '+' accurateMode=False '+' ====='
    relationScorer(OrelationDict, OnameDict, OactionList, OotherList, AsenDict, exact=False)



    '''
    OsentenceDict, OsentenceList, OnameDict, OpeopleList, OorgList = initializeDict('../docs/standard.xlsx')

    print '===== '+' jieba '+' useExpanded=[1,1,1] '+'[organization, people, undefined]'+' accurateMode=False '+' ====='
    ArsenDict, AnameDict, ApeopleList, AorgList, AundfList = NER_PO('资讯', 'https://www.jiqizhixin.com/articles/2018-10-25-8', useExpanded=[1,1,1])
    sentenceScorer(ArsenDict, OsentenceDict, OsentenceList)
    overAllScorer(OpeopleList+OorgList, ApeopleList+AorgList+AundfList)
    catagorizeScorer([OpeopleList, OorgList], [ApeopleList, AorgList, AundfList])

    print '===== '+' jieba '+' useExpanded=[1,0,1] '+'[organization, people, undefined]'+' accurateMode=False '+' ====='
    ArsenDict, AnameDict, ApeopleList, AorgList, AundfList = NER_PO('资讯', 'https://www.jiqizhixin.com/articles/2018-10-25-8', useExpanded=[1,0,1])
    sentenceScorer(ArsenDict, OsentenceDict, OsentenceList)
    overAllScorer(OpeopleList+OorgList, ApeopleList+AorgList+AundfList)
    catagorizeScorer([OpeopleList, OorgList], [ApeopleList, AorgList, AundfList])
    
    print '===== '+' jieba '+' useExpanded=[0,0,1] '+'[organization, people, undefined]'+' accurateMode=False '+' ====='
    ArsenDict, AnameDict, ApeopleList, AorgList, AundfList = NER_PO('资讯', 'https://www.jiqizhixin.com/articles/2018-10-25-8', useExpanded=[0,0,1])
    sentenceScorer(ArsenDict, OsentenceDict, OsentenceList)
    overAllScorer(OpeopleList+OorgList, ApeopleList+AorgList+AundfList)
    catagorizeScorer([OpeopleList, OorgList], [ApeopleList, AorgList, AundfList])

    print '===== '+' jieba '+' useExpanded=[0,0,0] '+'[organization, people, undefined]'+' accurateMode=False '+' ====='
    ArsenDict, AnameDict, ApeopleList, AorgList, AundfList = NER_PO('资讯', 'https://www.jiqizhixin.com/articles/2018-10-25-8', useExpanded=[0,0,0])
    sentenceScorer(ArsenDict, OsentenceDict, OsentenceList)
    overAllScorer(OpeopleList+OorgList, ApeopleList+AorgList+AundfList)
    catagorizeScorer([OpeopleList, OorgList], [ApeopleList, AorgList, AundfList])
    ...
    print '===== '+'zh-NER-TF'+' ====='
    AnameDict, ApeopleList, AorgList, AundfList = transform('../docs/zh-NER-TF results.txt')
    overAllScorer(OpeopleList+OorgList, ApeopleList+AorgList+AundfList)
    catagorizeScorer([OpeopleList, OorgList], [ApeopleList, AorgList, AundfList])'''
